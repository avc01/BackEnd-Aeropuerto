...
namespace BackEnd_Aeropuerto.Migrations
{
    ...
    [Migration("20211025221019_new-models-v1")]
            ...
            modelBuilder.Entity("BackEnd_Aeropuerto.Models.Vuelo", b =>
                {
                    b.HasOne("BackEnd_Aeropuerto.Models.Aerolinea", "Aerolineas")
                        .WithOne()
                        .HasForeignKey("BackEnd_Aeropuerto.Models.Vuelo", "AerolineaId")
                    ...
                    b.HasOne("BackEnd_Aeropuerto.Models.EstadoVuelo", "EstadoVuelos")
                        .WithOne()
                        .HasForeignKey("BackEnd_Aeropuerto.Models.Vuelo", "EstadoVueloId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BackEnd_Aeropuerto.Models.Puerta", "Puertas")
                        .WithOne()
                        .HasForeignKey("BackEnd_Aeropuerto.Models.Vuelo", "PuertaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
